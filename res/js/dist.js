...
var navigatorLanguage = window.navigator && (window.navigator.languages && window.navigator.languages[0] || window.navigator.userLanguage || window.navigator.language) || 'en';
...
var currentLanguage = localStorage && localStorage[window.lsPrefix + 'currentLanguage'] ? localStorage[window.lsPrefix + 'currentLanguage'] : languageToUse;
var ractive = new Ractive({
  ...
  oninit: function () {
    ...
    this.on('showConfirm', function (ev) {
      ...
      var topicsHTML = simulation.topics.map(function (t) {
        return "<li>" + t + "</li>";
      }).join('');
